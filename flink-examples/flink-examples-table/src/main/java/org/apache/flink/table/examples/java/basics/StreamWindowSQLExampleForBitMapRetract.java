 ...
 */
public class StreamWindowSQLExampleForBitMapRetract {
    private static final Logger logger = LoggerFactory.getLogger(StreamWindowSQLExampleForBitMapRetract.class);
...
//                        + "0,25041737386170,20,2025-04-17 17:48:58\n"
        ...
        String aggSql = "create view agg as select node,bitMapCountWithRetract(ticket_no) filter (where status <> 50) as cnt from union_view group by node";
